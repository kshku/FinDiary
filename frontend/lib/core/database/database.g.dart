...
class Family extends DataClass implements Insertable<Family> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, name, ownerId, createdAt, updatedAt, syncStatus);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Family &&
...
class FamilyMember extends DataClass implements Insertable<FamilyMember> {
  ...
  @override
  int get hashCode => Object.hash(familyId, userId, role, joinedAt, invitedBy);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class $SyncMetaTable extends SyncMeta
  ...
  @override
  late final GeneratedColumn<int> lastCheckpoint = GeneratedColumn<int>(
    'last_checkpoint',
    aliasedName,
    false,
    type: DriftSqlType.int,
  ...
  @override
  Set<GeneratedColumn> get $primaryKey => {scopeId, scopeType};
  @override
...
class SyncMetaData extends DataClass implements Insertable<SyncMetaData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['last_checkpoint'] = Variable<int>(lastCheckpoint);
  ...
  factory SyncMetaData.fromJson(
    ...
    return SyncMetaData(
      ...
      lastCheckpoint: serializer.fromJson<int>(json['lastCheckpoint']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'lastCheckpoint': serializer.toJson<int>(lastCheckpoint),
  ...
  @override
  int get hashCode =>
      Object.hash(scopeId, scopeType, lastCheckpoint, lastSyncedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class SyncMetaCompanion extends UpdateCompanion<SyncMetaData> {
  ...
  final Value<int> lastCheckpoint;
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (lastCheckpoint.present) {
      map['last_checkpoint'] = Variable<int>(lastCheckpoint.value);
    }
...
class $$SyncMetaTableFilterComposer
  ...
  ColumnFilters<int> get lastCheckpoint => $composableBuilder(
...
class $$SyncMetaTableOrderingComposer
  ...
  ColumnOrderings<int> get lastCheckpoint => $composableBuilder(
    column: $table.lastCheckpoint,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$SyncMetaTableAnnotationComposer
  ...
  GeneratedColumn<int> get lastCheckpoint => $composableBuilder(
    column: $table.lastCheckpoint,
    builder: (column) => column,
  );
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<int> lastCheckpoint = const Value.absent(),
                Value<String?> lastSyncedAt = const Value.absent(),
                Value<int> rowid = const Value.absent(),
              }) => SyncMetaCompanion(
                scopeId: scopeId,
